...
const Signup = () => {
  ...
  const handleChange = (e) => {
    setSignupUser({ ...signupUser, [e.target.id]: e.target.value });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (signupUser.password !== signupUser.confirmPassword) {
      toast.warning("Password doesn't match with Confirm Password");
      return;
    }
    ...
    try {
      ...
      const formattedName = `${capitalizeFirstLetter(
        signupUser.firstName
      )} ${capitalizeFirstLetter(signupUser.lastName)}`;
      ...
      <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
        ...
        <div className="hidden lg:relative lg:block lg:p-12">
          ...
          <p className="mt-4 leading-relaxed text-white/90">
            Generate your course with Cognita in ease with the help of AI. Enjoy
            your learning.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-xl lg:max-w-3xl">
          <div className="relative -mt-16 block lg:hidden">
            ...
            <p className="mt-4 leading-relaxed text-gray-400">
              Generate your course with Cognita in ease with the help of AI.
              Enjoy your learning.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
            <div className="col-span-6 sm:col-span-3">
              ...
              <input
                ...
                id="firstName"
                name="first_name"
                className="mt-1 p-2 w-full rounded-md border-gray-200 bg-white text-sm"
            ...
            <div className="col-span-6 sm:col-span-3">
              ...
              <input
                ...
                name="last_name"
                onChange={handleChange}
                className="mt-1 w-full p-2 rounded-md border-gray-200 bg-white text-sm"
              />
            </div>
